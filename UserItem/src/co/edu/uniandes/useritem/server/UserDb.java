...
public class UserDb {
	 ...
	 * @param data
	 * @return true if data could be stored or updated
	 */
	...
	public boolean saveUser(String data) {
		...
		try{
			...
			Class.forName(DBConstants.JDBC_DRIVER).newInstance();

			//STEP 3: Open a connection
			conn = (Connection) DriverManager.getConnection(DBConstants.DB_URL,DBConstants.USER,DBConstants.PASS);
...
//		System.out.println("Goodbye!");
	...
	public static void main(String[] args) {
		new UserDb().saveUser("35000|a|b|c");
	}
